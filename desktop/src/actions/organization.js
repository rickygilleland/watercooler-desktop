...
export function getOrganizationUsers(organization_id) {
    return (dispatch, getState, axios) => {
        ...
        try {
            axios.get(`https://blab.work/api/organization/${organization_id}/users`, {
                headers: {
                    'Accept': 'application/json',
                    'Authorization': 'Bearer '+state.auth.authKey,
                }
...
export function inviteUsers(emails) {
    return (dispatch, getState, axios) => {
        ...
        try {
            axios({
                method: 'post',
                url: `https://blab.work/api/organization/${organization_id}/users/invite`,
                data: { emails: emails },
                headers: {
                    'Accept': 'application/json',
                    'Authorization': 'Bearer '+state.auth.authKey,
