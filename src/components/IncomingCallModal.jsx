    ...
    return (
      ...
      >
        <Modal.Body>
            ...
            <center>
                <Button variant="danger" className="mx-3" onClick={() => handleIncomingCall("decline")} size="lg"><FontAwesomeIcon icon={faTimes} /> Decline</Button>
                <Button variant="success" className="mx-3" onClick={() => handleIncomingCall("accept")} size="lg"><FontAwesomeIcon icon={faPhone} /> Answer</Button>
            </center>
