        ...
        <Modal.Body className="mt-0 pt-0">
            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    ...
                    <Col xs={3}>
                        {props.loading == "true" ?
                            <Button className="btn-block" variant="primary" type="submit" disabled><FontAwesomeIcon icon={faCircleNotch} spin /> Starting Call</Button>
                        :
                            <Button className="btn-block" variant="primary" type="submit">Start Call</Button>
                        }
                    </Col>
                </Row>
            </Form>
