...
function RoomSettingsModal(props) {
    ...
    const [ audioEnabled, setAudioEnabled ] = useState(settings.roomSettings.audioEnabled);
    const [ videoEnabled, setVideoEnabled ] = useState(settings.roomSettings.videoEnabled);
    const [ backgroundBlurEnabled, setBackgroundBlurEnabled ] = useState(settings.roomSettings.backgroundBlurEnabled);
    ...
    function handleSettingsChange(event) {
        ...
        if (event.target.name == "backgroundBlur") {
            updateRoomSettings("backgroundBlurEnabled", backgroundBlurEnabled ? false : true);
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
            ...
            <p className="text-bold pt-0 mt-0">These settings will be used as the default when you join a room.</p> 
