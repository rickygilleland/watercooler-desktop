...
function RoomsModal(props) {
  ...
  return (
    ...
    >
      <Modal.Header>
        <Modal.Title className="font-weight-bolder">Create a Room</Modal.Title>
        <Button
          ...
          <Row>
            <Col xs="10">
              ...
              <p className="text-muted" style={{ fontSize: ".8rem" }}>
                We recommend setting the channel to audio only unless you'll be
                ...
                <OverlayTrigger
                  overlay={
                    <Tooltip id="tooltip-view-members">
                      Video rooms are unavailable on the Standard Plan.
                    </Tooltip>
                  }
                >
